...
namespace Aes
{
    public partial class Form1 : Form
    {
        ...
        byte[] inv_s_box =
        {
                                                                                                                                                                                                                                    //matematiskai suskaiciuotos reiksmes
        ...
        //busenos baitu pakeitimas naudojant pakeitimų S lenteles
        ...
        //busenos eiluciu cikliniai postumiai
        ...
        void rev_MixColumns(byte[] state)
        {
            //atvirkstinis Būsenos stulpelių maišymas.
            byte[] tmp = new byte[16];
        ...
        void rev_shiftrows(byte[] state)
        {   
            //atvirkstiniai busenos eiluciu cikliniai postumiai (i desine)
            byte[] tmp = new byte[16];
        ...
        void rev_subbytes(byte[] state)
        {
            for (int i = 0; i < 16; i++)
                state[i] = inv_s_box[state[i]];
        }

        void KeyExpansionCore(byte[] ins, byte i)
        {
            byte t = ins[0];
        ...
        //busenos sudetis su daliniu raktu
        void KeyExpansion(byte[] inputKey, byte[] expandedKeys)
        {
            for (int i = 0; i < 16; i++)
            ...
            while (bytesGenerated < 176)
            {
                ...
                {
                    KeyExpansionCore(temp, (byte)rConIteration);
                    rConIteration++;
                }
        ...
        void AES_Encrypt(byte[] message, byte[] key)
        {
